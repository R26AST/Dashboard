...
function submitExam(){
    ...
    document.querySelector(".content > div:last-child > div").innerHTML += "Jawaban Anda : "+ JSON.parse(localStorage.getItem('answer')).split(',').join(', ') +"<br> <br> <br>";
    document.querySelector(".content > div:last-child > div").innerHTML += "Kunci Jawaban : "+ kunci.split(',').join(', ') +"<br> <br> <br>";
