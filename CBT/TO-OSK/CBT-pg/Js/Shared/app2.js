...
function submitExam(){
    ...
    document.querySelector(".content > div:last-child > div").innerHTML += "Kunci Jawaban : "+ for(var i = 0; i < exam.questions.length; i++) {exam.questions[i].answerPosition} +"<br> <br> <br>";
